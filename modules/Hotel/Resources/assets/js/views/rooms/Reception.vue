                        ...
                        >
                            ...
                            <div class="card-rent">
                                ...
                                <template v-if="ro.status === 'MANTENIMIENTO'">
                                    <h4 class="text-center mb-0" style="color: #ff1500 !important;">
                                    <svg style="color: #ff1500 !important;" xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-tool"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 10h3v-3l-3.5 -3.5a6 6 0 0 1 8 8l6 6a2 2 0 0 1 -3 3l-6 -6a6 6 0 0 1 -8 -8l3.5 3.5" /></svg>
                                        <b style="color: #ff1500 !important;">En mantenimiento:</b>
                                    </h4>
                                ...
                                <div class="row" style="margin-right:0px;margin-left:0px;margin-top: auto;">
                                    ...
                                    <div
                                        :class="['col-9', 'room-actions-right', {
                                            'has-debt': (ro.status !== 'DISPONIBLE' || ro.is_active_reservation) && getRoomDebt(ro) > 0
                                        }]"
                                        style="padding-right:0px;position:relative;"
                                    >
                                        <!-- Deuda pendiente: en medio de los dos botones y ocupando
                                             todo el espacio libre; los botones se ajustan a su
                                             contenido para no quitarle ancho. -->
                                        <span
                                        ...
                                        <!-- Habitación ocupada: abre el modal de opciones -->
                                        <button
                                            v-else
                                ...
                                <el-button
                                    v-if="ro.status === 'DISPONIBLE' && !ro.is_active_reservation && canManageRooms"
...
/* Con deuda, el botón de estado se ajusta a su texto (lo más angosto posible)
   para que el aviso de deuda se quede con todo el espacio libre. */
.room-container .room-el-card .card-rent > .row > .col-9.room-actions-right.has-debt > .btn {
    flex: 0 0 auto;
    width: auto !important;
}

/* Aviso de deuda: el elemento más grande de la fila, en medio de los dos botones. */
.debt-indicator-btn {
    display: inline-flex;
    align-items: center;
    justify-content: center;
...
.has-reservation {
    background: linear-gradient(135deg, #0ea5e9 0%, #00334f 100%) !important;
    border: 0px solid #075985 !important;
    color: white !important;
    position: relative;
    overflow: hidden;
}
...
/* El contador (absolute, arriba-derecha) se superpone sobre el nombre de
   la habitación. Reservamos espacio en la parte superior del contenido
   para que el nombre/número fluya DEBAJO y no quede tapado. */
