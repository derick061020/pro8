                ...
                <div class="card-body invoice p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-2 card card-body bg-light-color my-1 mx-1 p-3 position-relative">
                            ...
                            <h4 class="m-0"><b>
                                {{ moment(currentRent.output_date).locale('es').format('ddd D MMM YYYY') }} <br>
                                {{ moment(currentRent.output_time, 'HH:mm:ss').locale('es').format('h:mm A') }}</b></h4>
                    ...
                    <div class="row card-body shadow-none mb-2">
                        <div class="col-12 h6 m-0">
                            <b><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-dollar"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><path d="M14 11h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3h-2.5" /><path d="M12 17v1m0 -8v1" /></svg> Información del comprobante (puedes emitir comprobante o nota de venta aunque ya esté pagado)</b>
                        </div>
                        <div class="col-lg-3">
                            <div
