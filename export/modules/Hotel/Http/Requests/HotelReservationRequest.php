...
class HotelReservationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        // Product y pagos solo obligatorios si payment_status es PAID
    ...
    {
        return [
            'rent_payment.payment_method_type_id.required' => 'El método de pago es obligatorio cuando el estado es PAGADO.',
            'rent_payment.payment_destination_id.required' => 'El destino del pago es obligatorio cuando el estado es PAGADO.',
        ];
    }
}
