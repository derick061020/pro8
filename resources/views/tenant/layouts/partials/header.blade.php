                        ...
                        <li>
                            <a role="menuitem" href="{{route('tenant.payment.index')}}"
                                ...
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" style="color:#3b4a63 !important;"
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" role="menuitem" href="{{route('tenant.payment.index')}}" style="color:#3b4a63 !important;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        stroke-linejoin="round"
                                        class="icon icon-tabler icons-tabler-outline icon-tabler-receipt-dollar me-2">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" style="color:#3b4a63 !important;" />
                                        <path
                                            d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16l-3 -2l-2 2l-2 -2l-2 2l-2 -2l-3 2" />
                                        <path
                                            d="M14.8 8a2 2 0 0 0 -1.8 -1h-2a2 2 0 1 0 0 4h2a2 2 0 1 1 0 4h-2a2 2 0 0 1 -1.8 -1" />
                                    ...
                                    <span style="color:#3b4a63 !important;">Mis Pagos</span>
                                </a>
                            </li>
                        @endif
                    @endif
